// We import 'useState' from React to handle "changing data" on the page (like opening/closing a menu).
// We import icons from 'lucide-react' to make the UI look professional without using images.
...
export default function Landing() {
  // This is a "State Variable". 'isMobileMenuOpen' is the value (true/false).
  // 'setIsMobileMenuOpen' is the function we use to change that value.
  // It starts as 'false' because the menu should be closed by default.
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false);

  // This function handles jumping to different sections of the page (Features, About, etc.)
  // when a user clicks a link in the navigation bar.
  const handleSmoothScroll = (elementId) => {
    const element = document.getElementById(elementId);
    if (element) {
      // behavior: 'smooth' makes the page glide down instead of jumping instantly.
      element.scrollIntoView({ behavior: 'smooth' });
      // We close the mobile menu after clicking a link so it doesn't stay open.
      setIsMobileMenuOpen(false);
    }
  };

  return (
    // Tailwind CSS (the 'className' strings) is used for styling. 
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <button 
                // This uses standard window navigation to go to the login/signup page.
            ...
            <div className="md:hidden">
              ...
              >
                {/* If the menu is open, show the 'X' icon. If closed, show the 'Menu' (hamburger) icon. */}
          ...
          {/* This part only appears IF isMobileMenuOpen is true. */}
          {isMobileMenuOpen && (
      ...
      {/* Hero Section - The big main area at the top of the page */}
      ...
      {/* Stats Section - Trust building numbers */}
      ...
      {/* CTA Section - Final push for the user to sign up */}
